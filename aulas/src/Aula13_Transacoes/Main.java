...
public class Main {
    ...
    private static final String sqlCreate = "DROP TABLE IF EXISTS Conta; CREATE TABLE Conta" +
            "("+"id INT PRIMARY KEY,"
    ...
    public static void main(String[] args) throws Exception {
        ...
        Conta conta = new Conta(1, "Daniel", "23dsfr36", 30);
